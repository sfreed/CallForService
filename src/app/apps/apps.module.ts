...
import { OfficerService } from '../common/services/officer.service';
...
import { OfficerQueueComponent } from './officers/officerQueue/officerQueue.component';
...
@NgModule({
  ...
  declarations: [ActiveListComponent, DispatcherHistoryComponent, CallMasterComponent, OfficerQueueComponent,
  ...
  providers: [ OfficerService, DispatcherHistory, UserDataService ],
  bootstrap: [  ],
